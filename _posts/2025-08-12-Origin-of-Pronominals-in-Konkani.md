...
The 3sɢ.ᴍ-ʀᴇʟ = **j̈o** जो /ˈ d͡zɔ/ “he” probably derives from Sanskrit Rɴᴏᴍ.sɢ.ᴍ-ᴘʀᴏx <sup>!</sup>yakaḣ <sup>!</sup>यकः (an extended form of yaḣ) which would have given Prakrit <sup>!</sup>jagō <sup>!</sup>जगो (we do find yaḣ becoming jō in Prakrit), which would be <sup>!</sup>jau <sup>!</sup>जौ in Apabhramsha, [jau → j̈o].  The remaining relative pronominals singular distal pronominals- 3sɢ.ғ-ᴅɪsᴛ = **ji** /ˈȡ͡ʑi(ː)/ “she” and 3sɢ.ɴ-ᴅɪsᴛ = **jẽ** /ˈȡ͡ʑɛ̃/  “it” are probably generated by analogy to 3sɢ.ғ/ɴ-ᴘʀᴏx/ᴅɪsᴛ [hi, hẽ] & [ti, tẽ].

<sup>!</sup>yakaḣ → <sup>!</sup>jagō → <sup>!</sup>jaɣo → <sup>!</sup>jao → jau → j̈o <br>
